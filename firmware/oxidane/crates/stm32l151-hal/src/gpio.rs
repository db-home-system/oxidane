...
// TODO the pins here currently correspond to the UFQFPN-48 package.
// There should be Cargo features that let you select different microcontroller packages.
...
gpio!(GPIOA, gpioa, gpioa, gpiopaen, gpioarst, PAx, [
...
gpio!(GPIOB, gpiob, gpiob, gpiopben, gpiobrst, PBx, [
...
gpio!(GPIOC, gpioc, gpioc, gpiopcen, gpiocrst, PCx, [
