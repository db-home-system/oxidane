#ifndef __SI4455_DEFS_H
#define __SI4455_DEFS_H

#include <stdint.h>
#include <stddef.h>

struct Si4455_GenericReply
{
    uint8_t  data[16];
};

struct Si4455_PartInfo
{
    uint8_t  chip_rev;
    uint16_t part;
    uint8_t  build;
...
struct Si4455_TestData
{
    uint8_t  test[16];
};

struct Si4455_FuncInfo
{
    uint8_t  rev_ext;
    uint8_t  rev_branch;
    uint8_t  rev_int;
...
struct Si4455_Property
{
    uint8_t  data[16];
};

struct Si4455_GpioPinCfg
{
    uint8_t  gpio0;
    uint8_t  gpio1;
    uint8_t  gpio2;
...
struct Si4455_FifoInfo
{
    uint8_t  rx_fifo_count;
    uint8_t  tx_fifo_space;
};

struct Si4455_EZConfigCheck
{
    uint8_t  result;
};

struct Si4455_IntStatus
{
    uint8_t  int_pend;
    uint8_t  int_status;
    uint8_t  ph_pend;
...
struct Si4455_PhStatus
{
    uint8_t  ph_pend;
    uint8_t  ph_status;
};

struct Si4455_ModemStatus
{
    uint8_t  modem_pend;
    uint8_t  modem_status;
    uint8_t  curr_rssi;
...
struct Si4455_DeviceState
{
    uint8_t  curr_state;
    uint8_t  curr_channel;
};

struct Si4455_CmdBuff
{
    uint8_t  data[16];
};
...
{
    uint8_t                         raw[16];
    struct Si4455_GenericReply      generic;
    struct Si4455_PartInfo          part_info;
    struct Si4455_TestData          test_data;
    struct Si4455_FuncInfo          func_info;
    struct Si4455_Property          property;
    struct Si4455_GpioPinCfg        gpio_pin_cfg;
    struct Si4455_FifoInfo          fifo_info;
    struct Si4455_EZConfigCheck     ezconfig_check;
    struct Si4455_IntStatus         int_status;
    struct Si4455_PhStatus          ph_status;
    struct Si4455_ModemStatus       modem_status;
    struct Si4455_ChipStatus        chip_status;
    struct Si4455_DeviceState       device_state;
    struct Si4455_CmdBuff           cmd_buff;
    struct Si4455_FrrA              frr_a;
    struct Si4455_FrrB              frr_b;
    struct Si4455_FrrC              frr_c;
    struct Si4455_FrrD              frr_d;
    struct Si4455_AdcReading        adc_reading;
    struct Si4455_PacketInfo        packet_info;
};
